...
export default class SuperfundMap extends Component {
  constructor(props) {
    ...
    this.zoomScale =  scaleLinear({ range: [8.5, 10.25], domain: [300, 1440], clamp: true});
  ...
  _size() {
    this._onChangeViewport({
      width: '100%',
      height: window.outerHeight * (2/3),  // user outerHeight s.t. doesnt resize when mobile scroll up / down.
